(function(global, factory) {
    ...
    function attachVariables() {
        this.variables =
            Array.isArray(this.raw_data) && this.raw_data.length
    ...
    function defineSupersets() {
        ...
        if (this.variables.includes(this.config.population_superset_col)) {
            ...
            if (
                this.supersets.length &&
                !this.variables.includes(this.config.population_order_col)
            ) {
            ...
            .text(function(d) {
                return _this.categories.find(function(category) {
                    ...
                    _this.config.useCategoryInfo
                        ...
                        : _this.config.useCategory
                            ? _this.config.category_col
                            : _this.config.category_abbreviation_col
                ];
            });
    }
    ...
    function addVariables() {
        ...
        this.raw_data.forEach(function(d) {
            if (_this.variables.includes(_this.config.date_col))
